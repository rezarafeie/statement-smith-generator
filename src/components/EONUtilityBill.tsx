...
export const EONUtilityBill: React.FC<EONUtilityBillProps> = ({ userDetails }) => {
  return (
    <div className="w-full max-w-4xl mx-auto bg-white" style={{ fontFamily: 'Arial, Helvetica, sans-serif' }}>
      <div className="min-h-screen p-3" style={{ fontSize: '11px', lineHeight: '1.1' }}>
        ...
        <div className="flex gap-3">
          ...
          <div className="flex-1" style={{ maxWidth: '60%' }}>
            ...
            <div className="flex justify-between items-start mb-3">
              <div style={{ fontSize: '9px', lineHeight: '1.0' }}>
            ...
            {/* Main Title */}
            <div className="mb-3">
              <h1 className="font-bold mb-0.5 text-gray-900" style={{ fontSize: '18px', fontWeight: 'bold' }}>Your energy account</h1>
              <div className="font-bold mb-0.5" style={{ fontSize: '11px', fontWeight: 'bold' }}>for 2 Frederick Street Kings Cross London WC1X 0ND.</div>
              <div className="font-normal mb-2" style={{ fontSize: '11px', fontWeight: 'normal' }}>29th Aug. 2022 - 28th Sept. 2022</div>
            </div>

            {/* Previous Balance */}
            <div className="mb-2">
              <div className="bg-gray-800 text-white p-1.5 flex justify-between items-center" style={{ fontSize: '10px' }}>
            ...
            {/* Charges Section */}
            <div className="mb-2">
              <h2 className="font-bold mb-0.5" style={{ color: '#e31e24', fontSize: '11px' }}>1. We have charged you</h2>
              <div style={{ fontSize: '9px' }} className="mb-1">Based on your meter readings.</div>
              
              <table className="w-full mb-1" style={{ fontSize: '9px' }}>
                <tbody>
                  <tr className="border-b border-gray-300">
                    <td className="py-0.5">Electricity</td>
                    <td className="py-0.5 text-center">28th Jun. 2023 - 27th Jul. 2023</td>
                    <td className="py-0.5 text-right font-medium">£82.52 DR</td>
                  </tr>
                  <tr className="border-b border-gray-300">
                    <td className="py-0.5">Gas</td>
                    <td className="py-0.5 text-center">28th Jun. 2023 - 27th Jul. 2023</td>
                    <td className="py-0.5 text-right font-medium">£34.48 DR</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            {/* Payment Section */}
            <div className="mb-2">
              <h2 className="font-bold mb-0.5" style={{ color: '#e31e24', fontSize: '11px' }}>2. You have paid</h2>
              <table className="w-full mb-1" style={{ fontSize: '9px' }}>
                <tbody>
                  <tr className="border-b border-gray-300">
                    <td className="py-0.5">Direct Debit collection</td>
                    <td className="py-0.5 text-right font-medium">20th Jul. 2023 £422.20 CR</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            {/* Payment Info */}
            <div className="mb-2" style={{ fontSize: '9px', lineHeight: '1.1' }}>
              <p>
          ...
          <div style={{ width: '40%' }}>
            ...
            <div className="mb-2">
              ...
              <div className="bg-white p-2 text-center" style={{ border: '1px solid black' }}>
                <span className="font-bold" style={{ fontSize: '14px' }}>A-73398C00</span>
                <div className="flex justify-center mt-0.5">
                  <img src="/lovable-uploads/c05923a2-25e4-4f2d-ac23-9ff3ee9ee5e1.png" alt="Color bars" className="h-0.5" />
                </div>
              </div>
            </div>
            ...
            <div className="mb-2">
              ...
              <div style={{ fontSize: '8px' }} className="mt-1.5 text-gray-600 leading-tight">
        ...
        {/* Footer */}
        <div className="mt-3 pt-1 border-t text-gray-600" style={{ fontSize: '8px' }}>
