          ...
          <div className="flex-1">
            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div className="text-sm">
                ...
                <div>{userDetails.postcode}</div>
                <div>{userDetails.phone || '+447412375153'}</div>
              </div>
            </div>
            ...
            <div className="mb-6">
              ...
              <div className="text-lg mb-2">for {userDetails.address} {userDetails.city} {userDetails.postcode}.</div>
              <div className="text-lg font-semibold mb-4">29th Aug. 2022 - 28th Sept. 2022</div>
            </div>
