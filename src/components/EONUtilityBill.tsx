  ...
  return (
    <div className="w-full mx-auto bg-white" style={{ fontFamily: 'Arial, Helvetica, sans-serif', maxWidth: '210mm', minHeight: '297mm' }}>
      <div className="p-6" style={{ fontSize: '11px', lineHeight: '1.2' }}>
        ...
        <div className="flex gap-6">
          ...
          <div className="flex-1" style={{ maxWidth: '75%' }}>
            ...
            <div className="mb-2">
              ...
              <div className="font-normal mb-1" style={{ fontSize: '11px', fontWeight: 'normal' }}>29th Aug. 2022 - 28th Sept. 2022</div>
            </div>
            ...
            <div className="mb-1">
              ...
              <div style={{ fontSize: '10px' }} className="mb-1">Based on your meter readings.</div>
              
              <table className="w-full mb-1" style={{ fontSize: '10px' }}>
                <tbody>
            ...
            {/* Payment Info */}
            <div className="mb-1" style={{ fontSize: '10px', lineHeight: '1.2' }}>
              <p>
          ...
          <div style={{ width: '25%' }}>
            ...
            <div className="mb-1">
              ...
              <div className="bg-white p-2 text-left">
                <span className="font-bold block" style={{ fontSize: '16px' }}>A-73398C00</span>
            ...
            {/* Bill Reference */}
            <div style={{ fontSize: '9px' }} className="mb-1">
            ...
            <div className="mb-1">
              ...
              <div style={{ fontSize: '8px' }} className="mt-1 text-gray-600 leading-tight">
        ...
        {/* Footer */}
        <div className="mt-3 pt-2 border-t text-gray-600" style={{ fontSize: '8px' }}>
