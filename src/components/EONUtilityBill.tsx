...
export const EONUtilityBill: React.FC<EONUtilityBillProps> = ({ userDetails }) => {
  return (
    <div className="w-full max-w-5xl mx-auto bg-white" style={{ fontFamily: 'Arial, Helvetica, sans-serif' }}>
      <div className="min-h-screen p-6" style={{ fontSize: '12px', lineHeight: '1.3' }}>
        ...
        <div className="flex justify-between items-start mb-6">
          ...
          <div className="text-right" style={{ fontSize: '11px' }}>
            <div className="font-bold mb-2" style={{ color: '#e31e24', fontSize: '12px' }}>Get in touch with us</div>
        ...
        <div className="flex gap-6">
          ...
          <div className="flex-1" style={{ maxWidth: '65%' }}>
            ...
            {/* Main Title */}
            <div className="mb-6">
              <h1 className="text-2xl font-normal mb-1 text-gray-900" style={{ fontSize: '24px' }}>Your energy account</h1>
              <div className="text-base mb-1" style={{ fontSize: '14px' }}>for 2 Frederick Street Kings Cross London WC1X 0ND.</div>
              <div className="text-base font-semibold mb-4" style={{ fontSize: '14px' }}>29th Aug. 2022 - 28th Sept. 2022</div>
            </div>

            {/* Previous Balance */}
            <div className="mb-4">
              <div className="bg-gray-800 text-white p-2 flex justify-between items-center" style={{ fontSize: '12px' }}>
            ...
            {/* Charges Section */}
            <div className="mb-4">
              <h2 className="text-base font-bold mb-1" style={{ color: '#e31e24', fontSize: '14px' }}>1. We have charged you</h2>
              <div style={{ fontSize: '11px' }} className="mb-2">Based on your meter readings.</div>
              
              <table className="w-full mb-3" style={{ fontSize: '12px' }}>
                <tbody>
            ...
            {/* Payment Section */}
            <div className="mb-4">
              <h2 className="text-base font-bold mb-1" style={{ color: '#e31e24', fontSize: '14px' }}>2. You have paid</h2>
              <table className="w-full mb-3" style={{ fontSize: '12px' }}>
                <tbody>
                  <tr className="border-b border-gray-300">
            ...
            {/* Payment Info */}
            <div className="mb-4" style={{ fontSize: '11px', lineHeight: '1.3' }}>
              <p>
          ...
          <div style={{ width: '35%' }}>
            ...
            {/* Account Number Box */}
            <div className="mb-4">
              <div className="font-bold mb-2 flex items-center gap-1" style={{ color: '#e31e24', fontSize: '12px' }}>
                <img src="/lovable-uploads/422992aa-59ff-4459-a271-99363753e72d.png" alt="Account" className="w-3 h-3" />
                Your account number:
              </div>
              <div className="bg-white border-2 border-gray-400 p-3 rounded text-center">
            ...
            {/* Bill Reference */}
            <div style={{ fontSize: '11px' }} className="mb-4">
              <div>Bill Reference: 72513189 (29th Jul. 2023)</div>
            </div>
            
            {/* Estimated Annual Cost */}
            <div className="mb-4">
              <div className="font-bold mb-2" style={{ color: '#e31e24', fontSize: '12px' }}>Your estimated annual cost</div>
              ...
              <div style={{ fontSize: '10px' }} className="mt-2 text-gray-600 leading-tight">
            ...
            <div className="mb-4">
              <div className="font-bold mb-1" style={{ color: '#e31e24', fontSize: '12px' }}>Could you pay less?</div>
              <div style={{ fontSize: '10px' }} className="text-gray-700 italic mb-2">
            ...
            <div className="mb-3">
              <div className="font-bold mb-1" style={{ fontSize: '12px' }}>Good to know.</div>
              <div style={{ fontSize: '10px' }} className="text-gray-700 mb-2">
                You're already on our cheapest tariff for your <strong>electricity</strong> usage. We'll let you know if this changes.
              </div>
              <div style={{ fontSize: '10px' }} className="text-gray-600 mb-2">
                For your <strong>gas</strong> (on meter point 711310402)
              </div>
              <div className="font-bold mb-1" style={{ fontSize: '12px' }}>Good to know.</div>
              <div style={{ fontSize: '10px' }} className="text-gray-700">
        ...
        {/* Footer */}
        <div className="mt-6 pt-3 border-t text-gray-600" style={{ fontSize: '10px' }}>
